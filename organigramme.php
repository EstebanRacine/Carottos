...
$salaries = [
        1 => ['prenom'=> "Oscar", "nom" =>"Rotte", "poste"=> "Dirigeant", "Description" =>"Oscar est l’employé ayant le plus d’expérience et c’est ce qui l’a poussé à en devenir le dirigeant à la suite de son père. Toute l’entreprise est familiale et bien qu’il soit censé rester dans un bureau à prendre les décisions marketing et à entendre les comptes rendus des employés, il n’est pas rare de le voir travailler dans les champs lors des récoltes.", "salaire" => 2900,
            "activités" => [["nom" => "Recevoir les clients", "pourcent"=>30], ["nom" => "Assurer la rentabilité", "pourcent"=>20], ["nom" => "Gestion des employés", "pourcent"=>20], ["nom" => "Vente de produits", "pourcent"=>10], ["nom" => "Verification de la qualité", "pourcent"=>10], ["nom" => "Aider dans les cultures", "pourcent"=>10]], "img"=>"images/salaries/oscar.jpg"],
        2 => ['prenom'=> "Rebecca", "nom" =>"Rotte", "poste"=> "Agriculteur", "Description" =>"Les agriculteurs de la compagnie Carottos sont les acteurs les plus importants de la société. Sans eux il n’y a pas de produits à distribuer. Ils s’occupent de tout ce qui est en rapport direct à la terre et à la pousse de nos légumes. Ils sèment, arrosent et récoltent.", "salaire" => 2300,
            "activités" => [["nom" => "Production des produits (arroser, dépôt d’engrais, etc.)", "pourcent"=>50], ["nom" => "Récolter les produits après production", "pourcent"=>20], ["nom" => "Aller vendre les produits", "pourcent"=>20], ["nom" => "Gérer les intérimaires en période estivale", "pourcent"=>10]],"img"=>"images/salaries/rebecca.jpg"],
        ...
        "activités" => [["nom" => "Production des produits (arroser, dépôt d’engrais, etc.)", "pourcent"=>50], ["nom" => "Récolter les produits après production", "pourcent"=>20], ["nom" => "Aller vendre les produits", "pourcent"=>20], ["nom" => "Gérer les intérimaires en période estivale", "pourcent"=>10]], "img"=>"images/salaries/lucas.jpg"],
        ...
        "activités" => [["nom" => "Organiser les dossiers", "pourcent"=>55], ["nom" => "Contact avec l’extérieur (fournisseurs, clients, etc…) aidée par sa supérieure", "pourcent"=>25], ["nom" => "Gestion des emplois du temps", "pourcent"=>15], ["nom" => "Faire le café", "pourcent"=>5]], "img"=>"images/salaries/clement.jpg"],
